    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_logisticsid', models.ForeignKey(blank=True, db_column='Asset_logisticsID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='PreEventManagement.assetlogistics')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('eventid', models.ForeignKey(db_column='EventID', on_delete=django.db.models.deletion.DO_NOTHING, to='PreEventManagement.event')),
            ],
            options={
                'db_table': 'schedule',
            },
