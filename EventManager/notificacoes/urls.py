...
urlpatterns = [
    ...
    path('limpar/<int:id>', views.limpar_notificacoes, name='limpar-notificacoes'),
    path('marcarcomolida', views.marcar_como_lida, name='ler-notificacoes'),
    ...
    path('apagarmensagem/<int:id>/<int:nr>', views.apagar_mensagem, name='apagar-mensagem'),
    path('limparmensganes/<int:id>', views.limpar_mensagens, name='limpar-mensagens'),
    path('marcarmensagemcomolida/<int:id>', views.mensagem_como_lida, name='ler-mensagens'),
]
